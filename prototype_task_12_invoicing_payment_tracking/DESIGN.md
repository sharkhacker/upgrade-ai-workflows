...
| 1. Issue | **GPT/Claude** | Issue email drafted: thanks, service summary, amount, due date, payment methods ([prompt](prompts/dunning_sequence.md)); invoice PDF attached from the firm's template |
...
Issue and dunning drafts (`sample_output/invoicing/`), a live action log, and a register where "who owes us what and how long" is a filter, not an afternoon of reconciliation.
