...
CLASSIFIER_SYSTEM = ((HERE / "prompts/correspondence_classifier.md")
                     .read_text(encoding="utf-8").split("```")[1].strip())
NOTIFIER_SYSTEM = ((HERE / "prompts/client_notification.md")
                   .read_text(encoding="utf-8").split("```")[1].strip())
...
def main():
    ...
    print("Human checkpoint: review drafts in sample_output/notifications/ before sending.")
