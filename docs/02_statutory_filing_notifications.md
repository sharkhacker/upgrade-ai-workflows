...
**Prototype: yes — [`prototypes/02_filing_notifications/`](../prototypes/02_filing_notifications/)**
...
| 2. Draft email | **GPT/Claude** | Generates the five-part notification ([prompt](../shared/prompts/filing_notification.md)); subject line carries the action, deadline and company name |
...
- One client-ready email per filing containing deadline, scope and fee (see `outputs/filing_notifications/` after running the prototype).
