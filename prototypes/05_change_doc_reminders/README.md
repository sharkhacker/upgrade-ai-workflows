...
2. Maintains a live register (`outputs/change_doc_register.csv`) with days outstanding, reminder stage, and each client's preferred channel and language.
3. Drafts every reminder in **both English and Traditional Chinese** (`shared/prompts/bilingual_change_doc_reminder.md`) with tone escalating by stage — gentle → firm → final-with-deadline.
