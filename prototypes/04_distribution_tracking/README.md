...
3. Drafts the stage-appropriate chaser email with Claude/GPT (template fallback without a key) into `outputs/chasers/`.
4. At stage 3, additionally generates the internal escalation memo to the company secretary (`outputs/secretary_escalation.txt`) suggesting phone follow-up.
