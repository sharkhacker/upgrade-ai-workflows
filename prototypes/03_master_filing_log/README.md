...
3. Writes the consolidated `outputs/master_filing_log.csv` (24 obligations across 10 companies in the demo) and prints an **alert digest** of everything overdue or due within 30 days.
4. Emits the daily digest email for the company secretary (`outputs/alert_digest_email.txt`).
